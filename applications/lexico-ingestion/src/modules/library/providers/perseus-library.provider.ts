      ...
      try {
        ...
        if (!author) {
          author = {
            name: rawAuthor,
            nickname: rawAuthor,
            path: xmlPath, // Using the first file path as author path for now
            slug: authorSlug,
            works: [],
          };
        ...
        // TEI usually uses <div type="textpart"> or <p> or <l> (lines)
        ...
        $("body")
          ...
          .each((_, elem) => {
            const $el = $(elem);
            // Avoid duplicate text if a <div type="textpart"> contains <p> or <l>
            ...
            // Replace lots of whitespace with single space
