...
describe("majorAspects.events", () => {
  ...
  describe("getMajorAspectEvent", () => {
    it("should create perfective conjunction event", () => {
      ...
      const event = buildMajorAspectEvent({
        longitudeBody1: 0,
        longitudeBody2: 0,
        timestamp,
        body1: "sun",
  ...
  describe("getMajorAspectProgressiveEvents", () => {
    ...
    it("should create progressive events from forming and dissolving pairs", () => {
      ...
      const progressiveEvents = getMajorAspectProgressiveEvents(events);
    ...
    it("should handle empty events array", () => {
      const progressiveEvents = getMajorAspectProgressiveEvents([]);
