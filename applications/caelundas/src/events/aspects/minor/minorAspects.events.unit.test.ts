...
describe("minorAspects.events", () => {
  ...
  describe("getMinorAspectEvent", () => {
    it("should create perfective semisextile event", () => {
      ...
      const event = buildMinorAspectEvent({
        longitudeBody1: 0,
        longitudeBody2: 30,
        timestamp,
        body1: "sun",
  ...
  describe("getMinorAspectProgressiveEvents", () => {
    ...
    it("should create progressive events from forming and dissolving pairs", () => {
      ...
      const progressiveEvents = getMinorAspectProgressiveEvents(events);
    ...
    it("should handle empty events array", () => {
      const progressiveEvents = getMinorAspectProgressiveEvents([]);
