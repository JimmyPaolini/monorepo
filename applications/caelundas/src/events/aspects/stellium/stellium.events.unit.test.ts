...
describe("stellium.events", () => {
  ...
  describe("getStelliumProgressiveEvents", () => {
    it("should return empty array for empty input", () => {
      const events = getStelliumProgressiveEvents([]);
    ...
    it("should return empty array when no stellium events exist", () => {
      ...
      const progressiveEvents = getStelliumProgressiveEvents(events);
    ...
    it("should create progressive event from forming to dissolving pair", () => {
      ...
      const progressiveEvents = getStelliumProgressiveEvents([
        formingEvent,
        dissolvingEvent,
      ]);
    ...
    it("should not create progressive event when only forming exists", () => {
      ...
      const progressiveEvents = getStelliumProgressiveEvents([formingEvent]);
    ...
    it("should not create progressive event when only dissolving exists", () => {
      ...
      const progressiveEvents = getStelliumProgressiveEvents([dissolvingEvent]);
