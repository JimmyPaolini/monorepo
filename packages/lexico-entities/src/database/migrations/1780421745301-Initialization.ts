 ...
 *
 */
export class Initialization1780421745301 implements MigrationInterface {
  name = "Initialization1780421745301";
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_9bc0b8d1aa44faf6ebfde865a2" ON "translations" ("translation_full_text_search") `,
    );
    await queryRunner.query(
