 ...
 *
 */
export class Migration1781041105615 implements MigrationInterface {
  name = "Migration1781041105615";
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "translations" ("created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "created_by" uuid, "deleted_at" TIMESTAMP WITH TIME ZONE, "deleted_by" uuid, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_by" uuid, "translation" text NOT NULL, "translation_full_text_search" tsvector GENERATED ALWAYS AS (to_tsvector('english', translation)) STORED, "lexeme_id" uuid, CONSTRAINT "PK_aca248c72ae1fb2390f1bf4cd87" PRIMARY KEY ("id")); COMMENT ON COLUMN "translations"."created_at" IS 'Timestamp when the record was created'; COMMENT ON COLUMN "translations"."created_by" IS 'UUID of the user or process that created the record'; COMMENT ON COLUMN "translations"."deleted_at" IS 'Timestamp when the record was soft-deleted'; COMMENT ON COLUMN "translations"."deleted_by" IS 'UUID of the user or process that soft-deleted the record'; COMMENT ON COLUMN "translations"."id" IS 'Auto-generated UUID primary key'; COMMENT ON COLUMN "translations"."updated_at" IS 'Timestamp when the record was last updated'; COMMENT ON COLUMN "translations"."updated_by" IS 'UUID of the user or process that last updated the record'; COMMENT ON COLUMN "translations"."translation" IS 'English translation text'; COMMENT ON COLUMN "translations"."lexeme_id" IS 'Auto-generated UUID primary key'`,
    );
    await queryRunner.query(
