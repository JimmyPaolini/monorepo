...
Failing command: `npx nx run synchronization:sync-conventional-config:check`

Config: [scripts/sync-conventional-config.ts](../../../scripts/sync-conventional-config.ts)

Fix: Run `npx nx run synchronization:sync-conventional-config` and commit the generated changes.

#### 📋 Validate Pull Request Template

Failing command: `npx nx run synchronization:sync-pull-request-template:check`

Fix: Run `npx nx run synchronization:sync-pull-request-template` and commit.

#### 🎯 Validate Agent Skills

Failing command: `npx nx run synchronization:sync-agent-skills:check`

Fix: Run `npx nx run synchronization:sync-agent-skills` and commit.
...
npx nx run synchronization:sync-conventional-config:check
npx nx run synchronization:sync-pull-request-template:check
npx nx run synchronization:sync-agent-skills:check
