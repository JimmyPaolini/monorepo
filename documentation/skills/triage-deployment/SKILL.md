...
Failing command: `npx nx run monorepo:sync-conventional-config:check`

Config: [scripts/sync-conventional-config.ts](../../../scripts/sync-conventional-config.ts)

Fix: Run `npx nx run monorepo:sync-conventional-config` and commit the generated changes.

#### 📋 Validate Pull Request Template

Failing command: `npx nx run monorepo:sync-pull-request-template:check`

Fix: Run `npx nx run monorepo:sync-pull-request-template` and commit.

#### 🎯 Validate Agent Skills

Failing command: `npx nx run monorepo:sync-agent-skills:check`

Fix: Run `npx nx run monorepo:sync-agent-skills` and commit.
...
npx nx run monorepo:sync-conventional-config:check
npx nx run monorepo:sync-pull-request-template:check
npx nx run monorepo:sync-agent-skills:check
