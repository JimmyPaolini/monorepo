...
Guidelines for building scalable Node.js server-side applications with NestJS. Focus on TypeScript, decorators, dependency injection, and modern Node.js patterns.

## Core Principles

### Dependency Injection (DI)

NestJS uses a powerful DI container that manages the instantiation and lifetime of providers.
...
Organize code into feature modules that encapsulate related functionality.
...
Leverage decorators to define routes, middleware, guards, and other framework features.
