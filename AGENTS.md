...
- **[upsert-issue](.agents/skills/upsert-issue/SKILL.md)**: Use when converting implementation plans into many linked GitHub issues, or when creating/updating issue hierarchies with parent-sub-issue and dependency relationships plus consistent metadata.
