...
- **[imports-conventions](documentation/skills/imports-conventions/SKILL.md)**: Import organization conventions for TypeScript in this monorepo. Use when writing or reviewing imports, when ESLint reports import order errors, when asked about monorepo path aliases, type-only imports, file extensions in imports, or named vs default exports. Covers auto-sorted import order, NodeNext .js extensions, relative parent import avoidance, and the monorepo namespace.
