...
- Prefix nx commands with the workspace's package manager (e.g., `pnpm exec nx build`, `npm exec nx test`) - avoids using globally installed CLI
...
- **[mcp-github](documentation/skills/mcp-github/SKILL.md)**: Use gh CLI and git commands for GitHub repository operations — PRs, issues, branches, and code search. Use this skill when working with GitHub repositories programmatically.
