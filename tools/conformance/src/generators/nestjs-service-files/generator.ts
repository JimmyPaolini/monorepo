...
/**
 * Configuration options for the NestJS service files generator.
 */
interface GenerateNestjsServiceFilesOptions {
  module?: string;
  name: string;
  project?: string;
}
 ...
 */
export async function generateNestjsServiceFiles(
  tree: Tree,
  options: GenerateNestjsServiceFilesOptions,
