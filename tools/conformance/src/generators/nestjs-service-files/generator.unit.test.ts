...
import { generateNestjsServiceFiles } from "./generator";
...
describe("generateNestjsServiceFiles", () => {
  let tree: Tree;
  ...
  describe("file generation", () => {
    it("should generate service and unit test files under a subfolder", async () => {
      await generateNestjsServiceFiles(tree, {
  ...
  describe("name validation", () => {
    it("should throw when name is camelCase", async () => {
      await expect(
        generateNestjsServiceFiles(tree, {
          module: TARGET_MODULE,
          name: "myService",
          project: PROJECT_NAME,
        }),
