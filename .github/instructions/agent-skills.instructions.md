...
Run the [helper script]\(SKILL_DIR/scripts/helper.py) to automate common tasks.

See [API reference]\(SKILL_DIR/references/api_reference.md) for detailed documentation.

Use the [scaffold]\(SKILL_DIR/templates/scaffold.py) as a starting point.
```
...
- [ ] Step 1: Configure environment - see [workflow-setup.md]\(SKILL_DIR/references/workflow-setup.md#environment)
- [ ] Step 2: Build project - see [workflow-setup.md]\(SKILL_DIR/references/workflow-setup.md#build)
- [ ] Step 3: Deploy to staging - see [workflow-deployment.md]\(SKILL_DIR/references/workflow-deployment.md#staging)
- [ ] Step 4: Run validation - see [workflow-deployment.md]\(SKILL_DIR/references/workflow-deployment.md#validation)
- [ ] Step 5: Deploy to production - see [workflow-deployment.md]\(SKILL_DIR/references/workflow-deployment.md#production)
```
