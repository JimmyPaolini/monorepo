  ...
  workspaces: {
    ...
    "applications/lexico": {
      entry: [
        ...
        "vite.config.mts", // Vite app configuration uses project-scoped plugins and aliases
        "vitest.config.ts", // Vitest configuration imports vitest and merges project Vite config
      ],
      ignore: [
      ...
      project: ["src/**/*.{ts,tsx}", "vite.config.mts", "vitest.config.ts"],
    },
